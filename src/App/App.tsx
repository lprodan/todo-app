        ...
        {isAuthenticated !== undefined &&
            <header>
                ...
                <div className="user-email">
                    <span>{email}</span>
                    {isAuthenticated ? <button type="button" className="btn btn-sign-out" onClick={handleSignOut}>Sign Out</button> : ""}
                </div>
            </header>}
        <main>
            <Suspense fallback={<div className="message">Loading...</div>}>
                <Routes>
                    ...
                    {isAuthenticated !== undefined && <Route path="*" element={<Navigate to={isAuthenticated ? "/tasks" : "/auth/login"} />} />}
                </Routes>
            </Suspense>
        </main>
    </React.Fragment>
