            ...
            {({ values }) => {
                return <Form className="submit">
                    ...
                    <div className="btn-container">
                        <Link to="/auth/reset-password" className="btn btn-forgot-pass" title="ForgotPassword" state={values.email}>Forgot your password?</Link>
                        <button className="btn btn-submit" type="submit" title="Submit">
                            Log In
                        </button>
                        <span>Not registered yet?</span>
                        <Link to="/auth/signup" className="btn btn-login" title="Sign Up">Sign Up</Link>
                    </div>
                </Form>
            }}
        </Formik>
